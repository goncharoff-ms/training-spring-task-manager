...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public AjaxAuthenticationProvider(final UserDao userService, final BCryptPasswordEncoder encoder) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (user == null) {
            throw new BadCredentialsException("Authentication Failed. User == null");
        }
